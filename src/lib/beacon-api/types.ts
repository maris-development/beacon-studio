...
export type BeaconInstanceStatus = 'online' | 'offline' | 'unknown';

/**
 * The health of one node. The app keeps these values in memory only. A reload
 * therefore starts at {@link BeaconInstanceStatus} `unknown`.
 * See `@/services/beacon-instance-health`.
 */
export type BeaconInstanceHealth = {
    status: BeaconInstanceStatus;
 ...
 */
export type StoredBeaconInstance = {
    id: string; // uuid, autogenerated by the service
    name: string; // human readable name
    url: string; // url of the beacon instance
 ...
 * the stored fields and one selection. Use `@/services/beacon-instance` to read
 * or to change them. Never build or mutate an instance object by hand.
 *
