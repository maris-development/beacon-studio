...
/**
 * One configured Beacon node. The app persists a list of these and one
 * selection. Use `@/services/beacon-instance` to read or to change them.
 * Never build or mutate an instance object by hand.
 */
